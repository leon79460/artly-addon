 ...
 * @since 1.0.0
 */
class Artly_Testimonial extends Widget_Base {
	...
	public function get_title() {
		return __( 'Artly Testimonial ', 'artly-core' );
	}
	...
	protected function register_controls_section() {
		...
		$repeater->add_control(
			...
			[
				...
				senectus cursus vivamus volutpat penatibus' , 'textdomain' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					...
					[
						'testimonial_name' => esc_html__( 'Jhon Doe', 'textdomain' ),
					],
				],
			]
		);
...
$widgets_manager->register( new Artly_Testimonial() );